...
assert.equal(actual.reservationTotal, 250);
assert.equal(actual.adjustedShares, 4450);
assert.equal(actual.metricShares, 4450);
assert.equal(actual.sourceRemaining, 750);
assert.equal(actual.sourceBorrowed, 250);
assert.equal(actual.closedSourceRemaining, 3700);
